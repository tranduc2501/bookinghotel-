<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageDPKS.master" AutoEventWireup="true" CodeFile="phonghot.aspx.cs" Inherits="phonghot" %>

<asp:Content ID="Content1" ContentPlaceHolderID="TieuDe" Runat="Server">Phòng hot
</asp:Content>
                ...
                <div class="col-md-12" style="border-bottom: solid 1px #33CA00; padding-bottom: 5px; margin-bottom: 20px">
                    <asp:HyperLink runat="server" NavigateUrl='<%# "/chitiet.aspx?phong=" + Eval("id") %>' Text='<%# Eval("Name") %>' ToolTip='<%# Eval("Name") %>'></asp:HyperLink><br />
                      ...
                      <div class="card">
                        ...
                        <div class="card-body">
                            Giá <asp:Literal runat="server" Text='<%#String.Format("{0:000,0 đ}", Eval("price")) + "/h" %>'></asp:Literal> - Lượt đặt: <asp:Literal runat="server" Text='<%# Eval("xuatHien") %>'></asp:Literal><br />
