<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/SiteAdmin.master" AutoEventWireup="true" CodeFile="User.aspx.cs" Inherits="Admin_User" %>
                ...
                <div class="dataTable_wrapper">
                    <asp:GridView ID="grvKhachSan" runat="server" AutoGenerateColumns="False" ClientIDMode="Static" CssClass="table table-striped table-bordered table-hover" OnRowDataBound="grvKhachSan_RowDataBound" AllowPaging="True" OnPageIndexChanging="grvKhachSan_PageIndexChanging" PageSize="5">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField AccessibleHeaderText="nameUser" DataField="email" HeaderText="Email">
                                <ItemStyle Width="80px" />
                            </asp:BoundField>
                            <asp:BoundField AccessibleHeaderText="nameRoom" DataField="provinceName" HeaderText="Tỉnh">
                            </asp:BoundField>
                            <asp:BoundField AccessibleHeaderText="creatAt" DataField="districtName" HeaderText="Huyện">
                                <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                            </asp:BoundField>
                            <asp:BoundField AccessibleHeaderText="timeStart" DataField="address" HeaderText="Địa chỉ">
                            </asp:BoundField>
                            <asp:BoundField AccessibleHeaderText="timeEnd" DataField="role" HeaderText="Quyền" />
                            <asp:BoundField AccessibleHeaderText="description" DataField="cmt" HeaderText="Chứng minh thư" />
                            <asp:BoundField DataField="phone" HeaderText="Điện thoại" >
                            <ItemStyle Width="120px" />
                            </asp:BoundField>
                            <asp:BoundField DataField="status" HeaderText="Hoạt động" />
                            <asp:BoundField DataField="createAt" HeaderText="Ngày " />
                            <asp:TemplateField>
                                <HeaderTemplate>
                                    Chức năng
                                </HeaderTemplate>
            ...
            <div class="panel-body">
                <div class="dataTables_wrapper">
                    ...
                    <div class="row show-grid">
                        ...
                        <asp:TextBox ID="txbID" runat="server" class="col-md-10" placeholder="ID tự động" ReadOnly="true" Style="cursor: not-allowed"></asp:TextBox>
                    </div>
                     <div class="row show-grid" >
                        <div class="col-md-2">
                            <asp:Label ID="Label5" runat="server" Text="Label">Email</asp:Label>
                        </div>
                        <asp:TextBox ID="txbEmail" runat="server" class="col-md-10" placeholder="Địa chỉ Email" Style="background-color: white !important"></asp:TextBox>
                    </div>
                    <div class="row show-grid">
                        <div class="col-md-2">
                            <asp:Label ID="Label3" runat="server" Text="Label">Tỉnh</asp:Label>
                        </div>
                        <div class="col-md-3">
                            <asp:DropDownList ID="cbbTinh" runat="server" AutoPostBack="true" OnSelectedIndexChanged="cbbTinh_SelectedIndexChanged" ></asp:DropDownList>
                        </div>
                    </div>
                    <div class="row show-grid">
                        <div class="col-md-2">
                            <asp:Label ID="Label7" runat="server" Text="Label">Huyện</asp:Label>
                        </div>
                        <div class="col-md-3">
                            <asp:DropDownList ID="cbbHuyen" runat="server" AutoPostBack="true" ></asp:DropDownList>
                        </div>
                    </div>
                    <div class="row show-grid" >
                        <div class="col-md-2">
                            <asp:Label ID="Label6" runat="server" Text="Label">Địa chỉ</asp:Label>
                        </div>
                        <asp:TextBox ID="txbDiaChi" runat="server" class="col-md-10" placeholder="Địa chỉ cụ thể" Style="background-color: white !important"></asp:TextBox>
                    </div>
                     <div class="row show-grid" >
                        <div class="col-md-2">
                            <asp:Label ID="Label12" runat="server" Text="Label">Quyền</asp:Label>
                        </div>
                        <div class="col-md-3" >
                            <asp:DropDownList ID="cbbQuyen" runat="server" >
                                <asp:ListItem Value="1">Admin</asp:ListItem>
                                <asp:ListItem Value="2">Quản Lý Khách Sạn</asp:ListItem>
                                <asp:ListItem Value="3">Người Dùng</asp:ListItem>
                            </asp:DropDownList>
                        </div>
                    </div>
                    <div class="row show-grid" >
                        <div class="col-md-2">
                            <asp:Label ID="Label8" runat="server" Text="Label">Chứng minh thư</asp:Label>
                        </div>
                        <asp:TextBox ID="txbCmt" runat="server" class="col-md-10" placeholder="Số chứng minh thư nhân dân" Style="background-color: white !important"></asp:TextBox>
                    </div>

                    <div class="row show-grid" >
                        <div class="col-md-2">
                            <asp:Label ID="Label10" runat="server" Text="Label">Số điện thoại</asp:Label>
                        </div>
                        <asp:TextBox ID="txbPhone" runat="server" class="col-md-10" placeholder="Phone numbers" Style="background-color: white !important"></asp:TextBox>
                    </div>
                     <div class="row show-grid">
                        <div class="col-md-2">
                            <asp:Label ID="Label9" runat="server" Text="Label">Đang hoạt động</asp:Label>
                        </div>
