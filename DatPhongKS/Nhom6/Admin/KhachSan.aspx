<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/SiteAdmin.Master" AutoEventWireup="true" CodeFile="KhachSan.aspx.cs" Inherits="Admin_KhachSan" %>
                ...
                <div class="dataTable_wrapper">
                    <asp:GridView ID="grvKhachSan" runat="server" AutoGenerateColumns="False" ClientIDMode="Static" CssClass="table table-striped table-bordered table-hover" OnRowDataBound="grvKhachSan_RowDataBound" AllowPaging="True" OnPageIndexChanging="grvKhachSan_PageIndexChanging" PageSize="5">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField AccessibleHeaderText="name" DataField="name" HeaderText="Tên khách sạn">
                                <ItemStyle Width="120px" />
                            </asp:BoundField>
                            <asp:BoundField AccessibleHeaderText="phone" DataField="phone" HeaderText="Điện thoại">
                                <ItemStyle Width="120px" />
                            </asp:BoundField>
                            <asp:BoundField AccessibleHeaderText="userID" DataField="email" HeaderText="Người đăng">
                                <ItemStyle Width="120px" />
                            </asp:BoundField>
                            <asp:BoundField AccessibleHeaderText="provinceID" DataField="ProvinceName" HeaderText="Tỉnh">
                                <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                            </asp:BoundField>
                            <asp:BoundField AccessibleHeaderText="districtID" DataField="DistrictName" HeaderText="Huyện" />
                            <asp:BoundField AccessibleHeaderText="address" DataField="address" HeaderText="Địa chỉ" />
                            <asp:ImageField AccessibleHeaderText="images" DataImageUrlField="thumb" HeaderText="Ảnh">
                            ...
                            <asp:BoundField AccessibleHeaderText="creatAt" DataField="creatAt" HeaderText="Ngày đăng" />
                            <asp:TemplateField>
                                <HeaderTemplate>
                                    Chức năng
                                </HeaderTemplate>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="dataTables_wrapper">
                    ...
                    <div class="row show-grid">
                        <div class="col-md-2">
                            <asp:Label ID="Label3" runat="server" Text="Label">Tên khách sạn</asp:Label>
                        </div>
                        <asp:TextBox ID="txbTenKhachSan" runat="server" class="col-md-10" placeholder="Tên khách sạn" Style="background-color: white !important"></asp:TextBox>
                    </div>
                    <div class="row show-grid">
                        <div class="col-md-2">
                            <asp:Label ID="Label15" runat="server" Text="Label">Địa chỉ</asp:Label>
                        </div>
                        <asp:TextBox ID="txbDiaChi" runat="server" class="col-md-10" placeholder="Địa chỉ khách sạn" Style="background-color: white !important"></asp:TextBox>
                        <div class="col-md-2">
                            <asp:Label ID="Label7" runat="server" Text="Label">Tên tỉnh</asp:Label>
                        </div>
                        <div class="col-md-3">
                            <asp:DropDownList ID="cbbTenTinh" runat="server" AutoPostBack="true" OnSelectedIndexChanged="cbbTenTinh_SelectedIndexChanged" ></asp:DropDownList>
                        </div>
                        
                        <div class="col-md-2">
                            <asp:Label ID="Label12" runat="server" Text="Label">Tên Huyện</asp:Label>
                        </div>
                        <div class="col-md-3" >
                            <asp:DropDownList ID="cbbTenHuyen" runat="server" ></asp:DropDownList>
                        </div>
                    </div>
                    <div class="row show-grid" >
                        <div class="col-md-2">
                        ...
                        <asp:TextBox ID="txbDienThoai" runat="server" class="col-md-10" placeholder="Phone numbers" Style="background-color: white !important"></asp:TextBox>
                    </div>
                    <div class="row show-grid">
                        <div class="col-md-2">
                    ...
                    <div class="row show-grid">
                        <div class="col-md-2">
                            <asp:Label ID="Label13" runat="server" Text="Label">Chủ khách sạn</asp:Label>
                        </div>
                        <asp:DropDownList ID="cbbChuKhachSan" runat="server" Style="height:43px; width:auto"></asp:DropDownList>
                    </div>
                    <div class="row show-grid">
                        <div class="col-md-12">
                            <asp:Label ID="Label4" runat="server" Text="Label">Tóm tắt</asp:Label>
                            <asp:TextBox ID="txbTomTat" runat="server" TextMode="multiline" Rows="5" Width="100%"></asp:TextBox>
                        </div>
                        <div class="row show-grid">
                            <div class="col-md-12">
                                <asp:Label ID="Label5" runat="server" Text="Label">Mô tả chi tiết</asp:Label>
                            </div>
