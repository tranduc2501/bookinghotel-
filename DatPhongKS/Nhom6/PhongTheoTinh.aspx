<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageDPKS.master" AutoEventWireup="true" CodeFile="PhongTheoTinh.aspx.cs" Inherits="PhongTheoTinh" %>

<asp:Content ID="Content1" ContentPlaceHolderID="TieuDe" Runat="Server">
    Xem Phòng theo <asp:Literal runat="server" ID ="txtTinh" />
</asp:Content>
            ...
            <div class="list-group"  style="margin: 5px">
                    <h1 class="list-group-item active">
                     ...
                     <div class="list-group-item">
                         <asp:Image class="card-img-top" Width="370px" Height="200px" runat="server" ImageUrl='<%# DataBinder.Eval(Container.DataItem, "thumb") != null ? Eval("thumb") : "/images/imageDefault.png" %>' />
                    <div class="card-body">
                        <h6 class="card-subtitle mb-2 text-muted">Giá:
                            ...
                            <p class="card-text">Tại khu vực: <asp:Literal runat="server" Text='<%# Eval("DistrictName") %>'></asp:Literal></p>
